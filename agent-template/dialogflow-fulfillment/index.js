...
const CARD_CM_A = [{
  ...
  'type': 'accordion',
  'text':
      `Helpful resources:<ul><li>${CDC_HOUSEHOLD_CHECKLIST}</li><li>${CDC_ERRANDS}</li><li>${CDC_STRESS}</li><li>${CDC_CHILDREN}</li><li>${CDC_RECREATION}</li><li>${CDC_PETS}</li></ul>${CDC_COPING}`
}];
...
const CARD_G2 = [{
  ...
  'type': 'accordion',
  'text':
      `Learn:<ul><li>${CDC_PROTECT}</li><li>${CDC_SICK}</li><li>${CDC_QA}</li></ul>Watch:<ul><li>${YOUTUBE_CDC_PREVENT}</li><li>${YOUTUBE_CDC_WASH}</li><li>${YOUTUBE_CDC_MANAGE}</li></ul>`
}];
